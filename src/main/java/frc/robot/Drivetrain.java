...
public class Drivetrain {
  ...
  public Drivetrain() {
    ...
    Logger.recordOutput("Constant Value", 1);
  }

  /** Sets speeds to the drivetrain motors. */
  public void setSpeeds(DifferentialDriveWheelSpeeds speeds) {
    Logger.recordOutput("Drive States", speeds);
  ...
  public void drive(double xSpeed, double ySpeed, double rot) {
    setSpeeds(m_kinematics.toWheelSpeeds(new ChassisSpeeds(xSpeed, ySpeed, rot)));
  }
  ...
  public void periodic() {
    ...
    //("Test Pose", getPose());
    Logger.recordOutput("Test Pose", getPose());
  }
}
